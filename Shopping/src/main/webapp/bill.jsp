...
try{
	...
	// System.out.println("select * from shoppingusers inner join cart where cart.email='"+email+"' and cart.status='bill'");
	//ResultSet rs2=st.executeQuery("select * from shoppingusers inner join cart where cart.email='"+email+"' and cart.status='bill'");
	  ResultSet rs2=st.executeQuery("select * from shoppingusers inner join cart on shoppingusers.email=cart.email where cart.email='"+email+"' and cart.status='bill'");
